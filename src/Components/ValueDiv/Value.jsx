      ...
      <div className="grid gap-[10rem] grid-cols-3 item-center">
        <div className="singleGrid rounded-[10px] hover:bg-[#eeedf7] p-[1.5rem]">
          <div className="flex items-center gap-3">
            <div className="imgDiv p-[4px] rounded-[.8rem] h-[40px] w-[40px] flex items-center justify-center"></div>
            <span className="font-semibold text-textColor text-[18px]">
              Simplicity
            </span>
          </div>
          <p className="text-[13px] text-textColor opacity-[.7] py-[1rem]">
            Things being made beautiful are the heart of everything we do
          </p>
        </div>

        <div className="singleGrid rounded-[10px] hover:bg-[#f7edf5] p-[1.5rem]">
          <div className="flex items-center gap-3">
            <div className="imgDiv p-[4px] rounded-[.8rem] bg-inherit-[#dedef8] h-[40px] w-[40px] flex items-center justify-center"></div>
            <span className="font-semibold text-textColor text-[18px]">
              Simplicity
            </span>
          </div>
        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#fcfae3] p-[1.5rem]">
          ...
          <p className="text-[13px] text-textColor opacity-[.7] py-[1rem]">
            We work on basis of creating trust which can be nurtured through
            authenticity
          </p>
        </div>
      </div>

      <div className="card mt-[2rem] flex justify-between bg-gray-100 p-[5rem] rounded-[10px]">
        <div>
